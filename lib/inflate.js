...
import {
  inflateInit2, inflateGetHeader, inflate, inflateSetDictionary, inflateEnd
} from "./zlib/inflate.js";
import {
  assign, arraySet, shrinkBuf, flattenChunks, Buf8
} from "./utils/common.js";
import {
  binstring2buf, string2buf, utf8border, buf2string
} from "./utils/strings.js";
import {
  Z_OK, Z_FINISH, Z_NO_FLUSH, Z_NEED_DICT, Z_BUF_ERROR, Z_STREAM_END, Z_SYNC_FLUSH
 ...
 **/
function doInflateRaw(input, options) {
  options = options || {};
  options.raw = true;
